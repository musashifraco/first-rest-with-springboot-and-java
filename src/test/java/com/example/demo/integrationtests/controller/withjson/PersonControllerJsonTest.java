...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    public void testCreate() throws IOException {
        ...
        specification = new RequestSpecBuilder().addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_EXAMPLE)
    ...
    public void testCreateWithWrongOrigin() throws IOException {
        ...
        specification = new RequestSpecBuilder().addHeader(TestConfigs.HEADER_PARAM_ORIGIN, "http://other.com")
                .setBasePath("/api/person/v1")
                .setPort(TestConfigs.SERVER_PORT)
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
    ...
    private void mockPerson() {
        ...
        person.setFirstName("Stallman");
        person.setFirstName("New York City, New York, US");
        person.setFirstName("Male");
    }
