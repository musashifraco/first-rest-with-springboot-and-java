...
public class PersonController {
    ...
    @Operation(summary = "Finds peoples by name",
            ...
            responses = {@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    ...
                    @ApiResponse(description = "Success",
                            ...
                            content = {@Content(mediaType = "application/json",
                                    array = @ArraySchema(schema = @Schema(implementation = PersonVO.class)))})})
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByName(@PathVariable(value = "firstName") String firstName,
